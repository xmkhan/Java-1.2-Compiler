...
public class HierarchyGraph {
  ...
  public boolean areNodesConnected(HierarchyGraphNode node1, HierarchyGraphNode node2) {
    return nodeAIsParentOfNodeB(node1, node2) ||
      nodeAIsParentOfNodeB(node2, node1);
  }
